# Отчет по Облачной Лабораторной работе №1  
...
- финансовый анализ и управление затратами (FinOps);  
- упрощение сопоставления сервисов между разными провайдерами (актуально для ЛР2).
